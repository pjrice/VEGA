...
(add-act-r-command "run-model-from-python" 'run-model-from-python)


(defun reload-model-from-python ()
  (run-single '("No-Lines-Color-Box-refactor" "full-dm" "Top-To-Bottom-Left-To-Right-Box" "Relative-Positions-Color" "VG-Serial-Retrieve-Party" "click-closest-modified") nil t t)
)
(add-act-r-command "reload-model-from-python" 'reload-model-from-python)
...
(run-single '("BrowardBallot-refactor" "all-perfect-broward-test" "Vote-Left-Right-lv1" "Relative-Positions-Color-Practice" "VG-Serial-Retrieve-novbp-lv1-check" "click-closest-modified_practice" "Check-Left-Right-lv1") nil t t)
