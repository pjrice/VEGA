...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; 
;;; Filename    : DownEachColumn-Box-Instructions-B3.lisp
;;; Version     : 1
;;; 
...
;;;				: * Added productions to skim instructions
;;;     			: * Modified from DownEachColumn-Box-Instructions-B2.
...
=goal>
	state		checking-if-bottom-instr
	
)

;check if reach the bottom of the instructions
; if not, navigate to the next line (back to "read-left-instr-2")
(P Read-Current-Left-Instructions-4
...
(P Attend-Current-Left-Instructions-Text-2
=goal>
	state     attend-left-instr-2
...
; if left-instruction is skimmed (reach the bottom row of text), then vote for races under instructions


(P Attend-Current-Left-Instructions-Text-Done
...
;**********************************************************
; find the racebox in left column
