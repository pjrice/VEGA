		...
		(loop
            ...
            (loop
                ...
                (let* (
                    ...
                    (add-image-to-exp-window *window* "box" "lb.gif" :x (- current-x 5) :y (- current-y 5) :width 250 :height (+ y-spacing-after-title (* (- (list-length candidates) 1) y-spacing-between-candidates) (* (list-length (list (+ (list-length candidates) 1))) 14) 35) :clickable nil)
