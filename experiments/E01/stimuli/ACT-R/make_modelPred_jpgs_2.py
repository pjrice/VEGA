...
def mk_weightedModelPred_jpgs(scene,stimName,saveFolder,lineWidth=5,groupPad=12,scaleFactor=3):
...
def mk_grpFeatModelPred_jpgs(scene, stimName, saveFolder, lineWidth=5, groupPad=12, scaleFactor=3):
    ...
    # second, put the group labelings into the image
    for groupingIter in range(2,scene.groupGroupingIters+1):
