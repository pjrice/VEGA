...
def proc_display_monitor(cmd,params,success,results):
    ...
    try:
        ...
        if not vgConfig.modelIsVoting:
            ...
            # radius=8 for No-Lines-Color-Box
            if vgConfig.noImages:
                vgConfig.vgScene = vgClasses.visGroups(vgConfig.noImageVisicon,vgConfig.groupingRadius,vgConfig.collisionMethod)
            else:
                vgConfig.vgScene = vgClasses.visGroups(vgConfig.currentVisicon,vgConfig.groupingRadius,vgConfig.collisionMethod)
