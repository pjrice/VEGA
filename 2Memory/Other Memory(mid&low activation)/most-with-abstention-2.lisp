; dm only includes 70% of the ballot with high activations 
...
(sdp EliseEllzey :base-level .5)
(sdp PollyRylander :base-level .5)
(sdp JillianBalas :base-level .5)
(sdp WesleySteven-Millette :base-level .5)
