...
(sdp SusanneRael :base-level .4)
(sdp PeterVarga :base-level .4)
(sdp TimGrasty :base-level .4)

(sdp DerrickMelgar :base-level 0.3)
(sdp CoreyBehnke :base-level 0.3)
(sdp DeanCaffee :base-level 0.3)
(sdp JasonValle :base-level 0.3)
(sdp HowardGrady :base-level 0.3)
(sdp ClydeGaytonJr. :base-level 0.3)
(sdp LewisShine :base-level 0.3)
